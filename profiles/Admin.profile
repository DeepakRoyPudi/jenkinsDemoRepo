...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>TestDataFactory_SOSL</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TestDynamicApex</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TestOrderManagement</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TestQuoteExtension</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <fieldPermissions>
    ...
    <loginIpRanges>
        <endAddress>14.141.105.178</endAddress>
        <startAddress>14.141.105.178</startAddress>
    </loginIpRanges>
    <objectPermissions>
    ...
    <pageAccesses>
        <apexPage>OrderManagement</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
